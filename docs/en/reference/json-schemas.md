...
| [`app-runtime.schema.json`](/schemas/app-runtime.schema.json) | Validates `app.runtime.yaml` Agent task runtime contracts and App Server bridge profiles. |
| [`app-requirements.schema.json`](/schemas/app-requirements.schema.json) | Validates business requirements, MVP scope, non-goals, and acceptance criteria. |
| [`app-boundary.schema.json`](/schemas/app-boundary.schema.json) | Validates App / Host / Cloud / connector / external system / human responsibility boundaries. |
| [`app-integrations.schema.json`](/schemas/app-integrations.schema.json) | Validates host/cloud-managed external integration requirements. |
| [`app-operations.schema.json`](/schemas/app-operations.schema.json) | Validates operation side effects, approvals, dry-run, and evidence contracts. |
| [`app-install.schema.json`](/schemas/app-install.schema.json) | Validates in-Lime, standalone, runtime-backed, and web-host installation contracts plus runtime distribution metadata. |
| [`app-fit-report.schema.json`](/schemas/app-fit-report.schema.json) | Validates pre-implementation fit reports for business requirements. |
