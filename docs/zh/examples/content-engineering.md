...
这个示例把内容工程化做成 Product-level Agent App，而不是单个“内容专家”。它有自己的 UI、storage、workflow、worker、expert-chat entry、Knowledge 绑定、Artifact 和 Eval。
...
- `content-engineering-app` storage namespace 和 schema。
...
参考包：[`docs/examples/content-engineering-app/APP.md`](../examples/content-engineering-app/APP.md)
