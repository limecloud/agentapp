...
Readiness 回答的问题不是“结构是否正确”，而是“当前宿主和 workspace 是否能运行它”。一个 package 可以结构有效，但因为必需 Runtime、UI、Context、Knowledge、Skill、Tool / Connector、Artifact、Evidence、Policy、QC、capability、service 或 secret 未绑定而返回 `needs-setup`。
