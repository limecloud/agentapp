...
Agent App 面向 AI Host，必须组合 Agent Skills、Knowledge、Tools、Artifacts、Evidence、Policy、Runtime 和 QC。它还要处理模型任务、上下文组装、Evidence 和 Eval，这些不是传统小程序定义的内容。
...
- 用户激活前能否理解 App 需要哪些 data、Tools 和 secrets？
